...
from pythia.agent.network import LSTMChalvatzisTFFunc, OutputObserver

from .predictor import Predictor


class ChalvatzisPredictorFunc(Predictor):
    ...
    def __init__(self, input_size: int, output_size: int, window_size: int, hidden_size: int, dropout: float, all_hidden: bool,
        ...
        super(ChalvatzisPredictorFunc, self).__init__(input_size, output_size, predict_returns, first_column_cash)
        ...
        self.model: Optional[LSTMChalvatzisTFFunc] = None
        if self.normalize:
        ...
        self.model = LSTMChalvatzisTFFunc(
    ...
    def initialise(input_size: int, output_size: int, params: Dict) -> Predictor:
        ...
        return ChalvatzisPredictorFunc(input_size=input_size, output_size=output_size, window_size=window_size, hidden_size=hidden_size, 
    ...
    def copy_model(self) -> Any:
        ...
        model.build((self.model.input_layer.input_shape))
