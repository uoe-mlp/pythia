...
from pythia.agent.network import LSTMReLUCell



class _LSTMReLUSingleLayer(Module):
    ...
    def forward(self, x: Tensor, hidden: Optional[Tuple[Tensor, Tensor]] = None):
        ...
        result_tensor = stack(result, 0)
        return result_tensor, hidden

    @classmethod
    def from_params(cls, *args, **kwargs):
        cell = LSTMReLUCell.from_params(*args, **kwargs)
...
class _LSTMReLULayer(Module):
    ...
    def forward(self, x: Tensor, hidden: Optional[Tuple[Tensor, Tensor]] = None):
        ...
        if self.bidirectional:
            ...
            result = cat([result_fw, result_bw], result_fw.dim() - 1)
            h = stack([hidden_fw[0], hidden_bw[0]], 0)  # type: ignore
            c = stack([hidden_fw[1], hidden_bw[1]], 0)  # type: ignore
        else:
            result = result_fw
    ...
    def from_float(cls, other, layer_idx=0, qconfig=None, **kwargs):
        ...
        layer.layer_fw = _LSTMReLUSingleLayer.from_params(wi, wh, bi, bh)
        ...
        if other.bidirectional:
            ...
            layer.layer_bw = _LSTMReLUSingleLayer.from_params(wi, wh, bi, bh)
        return layer
...
class LSTMReLU(Module):
    ...
    def forward(self, x: Tensor, hidden: Optional[Tuple[Tensor, Tensor]] = None):
        ...
        hx_tensor = stack(hx_list)
        cx_tensor = stack(cx_list)
